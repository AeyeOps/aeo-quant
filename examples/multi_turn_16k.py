...
RESULTS_DIR = Path(os.environ.get("RESULTS_DIR", "results/context_scaling"))
...
def main() -> None:
    ...
    try:
        generate_dashboard(RESULTS_DIR, title="Gemma 4 FP8 — Context Scaling (KV Cache Reuse)")
